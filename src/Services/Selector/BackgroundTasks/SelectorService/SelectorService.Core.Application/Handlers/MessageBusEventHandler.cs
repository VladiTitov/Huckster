...
namespace SelectorService.Core.Application.Handlers
{
    internal class MessageBusEventHandler : IEventProcessor
    {
        ...
        public async void ProcessEvent(string message)
        {
            ...
            var searchCriteriaList = await _repositoryAsync.GetAllAsync();
